    ...
    def __init__(
        ...
        if self.path_to_structures:
            for name_trace in self.trace_name:
                self.trace[name_trace].on_click(
        ...
        self.widg_featcolor_list.observe(
            self.handle_featcolor_list_change, names="value"
        )
        self.widg_featcolor_type.observe(
            self.handle_featcolor_type_change, names="value"
        )
        self.widg_featmarker_maxvalue.observe(
            self.handle_featmarker_maxvalue_change, names="value"
        )
        self.widg_featmarker_minvalue.observe(
            self.handle_featmarker_minvalue_change, names="value"
        )
        ...
        self.widg_markers_symbol.observe(
            self.handle_markers_symbol_change, names="value"
        )
