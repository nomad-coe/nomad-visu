...
class ColormapDiscreteEnum(Enum):
...
class ColormapContinuousEnum(Enum):
...
class Config:
    ...
    colormap= ColormapContinuousEnum.viridis.value
    colormap_discrete= ColormapDiscreteEnum.Plotly.value
